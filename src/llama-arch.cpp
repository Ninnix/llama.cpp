...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_QWENGRAM_KEY,                           "qwengram.readers.%d.keys.0" },
    { LLM_TENSOR_QWENGRAM_VALUE,                         "qwengram.readers.%d.value" },
    { LLM_TENSOR_QWENGRAM_BETA,                          "qwengram.readers.%d.beta" },
    { LLM_TENSOR_QWENGRAM_GAMMA,                         "qwengram.readers.%d.gamma" },
    { LLM_TENSOR_QWENGRAM_GATE_W,                        "qwengram.arbiter.w" },
    { LLM_TENSOR_QWENGRAM_GATE_B,                        "qwengram.arbiter.b" },
    { LLM_TENSOR_QWENGRAM_ALPHA2,                        "qwengram.arbiter.alpha2" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_QWENGRAM_KEY,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_QWENGRAM_VALUE,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_QWENGRAM_BETA,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ADD}},
    {LLM_TENSOR_QWENGRAM_GAMMA,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_QWENGRAM_GATE_W,            {LLM_TENSOR_LAYER_INPUT, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_QWENGRAM_GATE_B,            {LLM_TENSOR_LAYER_INPUT, GGML_OP_ADD}},
    {LLM_TENSOR_QWENGRAM_ALPHA2,            {LLM_TENSOR_LAYER_INPUT, GGML_OP_MUL}},
